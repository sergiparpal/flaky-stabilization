...
_pii = importlib.import_module("flaky_stabilization.pii")
_detectors = importlib.import_module("flaky_stabilization.pii.detectors")
_scanner = importlib.import_module("flaky_stabilization.pii.scanner")
...
sys.modules.setdefault(
    "jira_incidents", importlib.import_module("flaky_stabilization.incidents")
)
